...
import NotificationIcon from '@material-ui/icons/NotificationImportantSharp';
        ...
        <div className="header">
            ...
            <div className='header_left'>
                ...
                <div className='header__input'>
                    <input onChange={e => setInputSearch(e.target.value)} value={inputSearch} type="text" className='inpbox' placeholder="Search..." />
            ...
            <div className='header__right'>
                ...
                <AppIcon className='Icons' />
                <NotificationIcon className='Icons' />
                <Avatar className='Icons avtarIcon' src='https://yt3.ggpht.com/FjeN785fVWx0Pr6xCbwPhhq8hHj_gocc3FygDXYDEQgp2gE_FQzRNsFHFAjQ3oE-VJaeGR1a=s176-c-k-c0x00ffffff-no-rj-mo' />
            </div>
